  ...
  return (
    <section id="faq" style={{ background: "#0c0b0a", padding: "96px 24px" }}>
      <div style={{ maxWidth: 800, margin: "0 auto" }}>
        <Reveal>
          <p style={{ color: "#BC9C22", fontSize: 12, letterSpacing: "0.15em", textTransform: "uppercase", marginBottom: 16 }}>Vragen</p>
          ...
          <Reveal key={i} delay={1}>
            <div style={{ borderTop: "1px solid #2a2720" }}>
              <button onClick={() => setOpen(open === i ? null : i)}
                ...
                <span style={{ color: "#BC9C22", fontSize: 24, marginLeft: 16, flexShrink: 0, transform: open === i ? "rotate(45deg)" : "none", transition: "transform 0.25s ease", display: "inline-block" }}>+</span>
              </button>
              <div style={{
