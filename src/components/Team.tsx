  ...
  return (
    <section id="team" style={{ background: "#131211", padding: "96px 0" }}>
      <div style={{ maxWidth: 1200, margin: "0 auto", padding: "0 24px" }}>
        <Reveal>
          <p style={{ color: "#BC9C22", fontSize: 12, letterSpacing: "0.15em", textTransform: "uppercase", marginBottom: 16 }}>De mensen</p>
        </Reveal>
          ...
          <div key={t.name} onMouseEnter={() => setHovered(t.name)} onMouseLeave={() => setHovered(null)}
            ...
            <div style={{ position: "relative", height: 460, overflow: "hidden" }}>
              ...
              <div style={{
                ...
                <p style={{ color: "#BC9C22", fontSize: 11, letterSpacing: "0.12em", textTransform: "uppercase", margin: "0 0 10px", fontWeight: 700 }}>Specialisaties</p>
                {t.specs.map((s) => (
                  <div key={s} style={{ display: "flex", alignItems: "center", gap: 10, marginBottom: 7 }}>
                    <span style={{ width: 7, height: 7, borderRadius: "50%", background: "#BC9C22", flexShrink: 0, display: "inline-block" }} />
