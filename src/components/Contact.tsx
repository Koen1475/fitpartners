      ...
      <div style={{ maxWidth: 640, margin: "0 auto" }}>
        <Reveal>
          ...
          <a href="mailto:info@fit-partners.nl?subject=Gratis intake aanvragen"
            style={{ display: "inline-block", background: "#dbca91", color: "#0c0b0a", padding: "18px 48px", fontWeight: 700, fontSize: 14, letterSpacing: "0.1em", textTransform: "uppercase", textDecoration: "none", transition: "background 0.2s" }}
