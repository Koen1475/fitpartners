  ...
  return (
    <section style={{ position: "relative", minHeight: "100vh", display: "flex", alignItems: "center", overflow: "hidden" }}>
      ...
      <div style={{ position: "relative", maxWidth: 1200, margin: "0 auto", padding: "0 24px", width: "100%" }}>
        ...
        <h1 className="hero-line-3" style={{ fontFamily: "var(--font-anton)", fontSize: "clamp(48px, 8vw, 96px)", lineHeight: 1, textTransform: "uppercase", color: "#dbca91", margin: "0 0 32px" }}>
          Weet wat werkt.
        </h1>
        ...
        <div className="hero-line-4" style={{ display: "flex", gap: 16, flexWrap: "wrap" }}>
          <a href="#contact" style={{ background: "#dbca91", color: "#0c0b0a", padding: "16px 36px", fontWeight: 700, fontSize: 14, letterSpacing: "0.08em", textTransform: "uppercase", textDecoration: "none", transition: "background 0.2s" }}
            onMouseEnter={(e) => (e.currentTarget.style.background = "#c9b87e")}
            onMouseLeave={(e) => (e.currentTarget.style.background = "#dbca91")}>
          ...
          <a href="#aanpak" style={{ border: "1px solid #a39d92", color: "#f4efe6", padding: "16px 36px", fontWeight: 600, fontSize: 14, letterSpacing: "0.05em", textTransform: "uppercase", textDecoration: "none", transition: "border-color 0.2s, color 0.2s" }}
            onMouseEnter={(e) => { e.currentTarget.style.borderColor = "#dbca91"; e.currentTarget.style.color = "#dbca91"; }}
