    ...
    >
      <div style={{
        ...
        <button onClick={close} style={{
          ...
          onMouseEnter={e => { e.currentTarget.style.color = "#f4efe6"; e.currentTarget.style.borderColor = "#BC9C22"; }}
        ...
        <div style={{ width: "42%", flexShrink: 0, position: "relative", minHeight: 480 }} className="modal-photo">
          ...
          <div style={{ position: "absolute", bottom: 36, left: 28, right: 28 }}>
            <p style={{ color: "#BC9C22", fontSize: 11, letterSpacing: "0.14em", textTransform: "uppercase", margin: "0 0 8px", fontWeight: 700 }}>Gratis en vrijblijvend</p>
        ...
        <div style={{ flex: 1, padding: "48px 40px 40px", overflowY: "auto", display: "flex", flexDirection: "column" }}>
          {sent ? (
            <div style={{ flex: 1, display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", textAlign: "center", gap: 20 }}>
              <CheckCircle size={48} color="#BC9C22" strokeWidth={1.5} />
              ...
              <button onClick={close} style={{ marginTop: 8, background: "#BC9C22", color: "#0c0b0a", border: "none", padding: "13px 32px", fontWeight: 700, fontSize: 13, letterSpacing: "0.08em", textTransform: "uppercase", cursor: "pointer" }}>
                Sluiten
              </button>
            </div>
          ) : (
            <>
              <div style={{ marginBottom: 36 }}>
                <p style={{ color: "#BC9C22", fontSize: 11, letterSpacing: "0.14em", textTransform: "uppercase", margin: "0 0 10px", fontWeight: 700 }}>FIT Partners</p>
                ...
                <div style={{ width: 36, height: 2, background: "#BC9C22", marginTop: 14 }} />
              </div>
              ...
              <form onSubmit={submit} style={{ display: "flex", flexDirection: "column", gap: 12, flex: 1 }}>
                <input
                  ...
                  style={{ ...inputStyle, borderColor: focused === "naam" ? "#BC9C22" : "#2a2720" }}
                />
                <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 12 }}>
                  <input
                    ...
                    onBlur={() => setFocused(null)}
                    style={{ ...inputStyle, borderColor: focused === "tel" ? "#BC9C22" : "#2a2720" }}
                  />
                  <input
                    required
                    type="email"
                    ...
                    onBlur={() => setFocused(null)}
                    style={{ ...inputStyle, borderColor: focused === "email" ? "#BC9C22" : "#2a2720" }}
                  />
                </div>
                <textarea
                  ...
                  onBlur={() => setFocused(null)}
                  style={{ ...inputStyle, resize: "vertical", lineHeight: 1.6, borderColor: focused === "msg" ? "#BC9C22" : "#2a2720" }}
                />
                ...
                <div style={{ marginTop: 8, display: "flex", alignItems: "center", justifyContent: "space-between", gap: 16 }}>
                  <p style={{ color: "#8c8780", fontSize: 12, margin: 0, lineHeight: 1.5 }}>
                    Of bel direct: <a href="tel:06-14634488" style={{ color: "#BC9C22", textDecoration: "none" }}>06-14634488</a>
                  </p>
