  ...
  return (
    <section id="aanpak" style={{ background: "#131211", padding: "96px 24px" }}>
      <div style={{ maxWidth: 1200, margin: "0 auto" }}>
        <Reveal>
          <p style={{ color: "#BC9C22", fontSize: 12, letterSpacing: "0.15em", textTransform: "uppercase", marginBottom: 16 }}>Werkwijze</p>
          ...
          {steps.map((s, i) => (
            <Reveal key={s.num} delay={(i + 1) as 1 | 2 | 3 | 4}>
              <div style={{ borderTop: "1px solid #2a2720", paddingTop: 28 }}>
                <div style={{ fontFamily: "var(--font-anton)", fontSize: 56, color: "#BC9C22", opacity: 0.2, lineHeight: 1, marginBottom: 16 }}>{s.num}</div>
