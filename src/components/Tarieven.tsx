  ...
  return (
    <section id="tarieven" style={{ background: "#131211", padding: "96px 24px" }}>
      <div style={{ maxWidth: 1200, margin: "0 auto" }}>
        <Reveal>
          <p style={{ color: "#b79d3e", fontSize: 12, letterSpacing: "0.15em", textTransform: "uppercase", marginBottom: 16 }}>Investering</p>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(260px, 1fr))", gap: 24 }}>
          {plans.map((p, i) => (
            <Reveal key={p.name} delay={(i + 1) as 1 | 2 | 3}>
              <div style={{
                background: p.featured ? "#b79d3e" : "#0c0b0a",
                padding: 40,
                position: "relative",
                ...
                {p.badge && (
                  <div style={{ position: "absolute", top: -1, right: 24, background: "#0c0b0a", color: "#b79d3e", fontSize: 11, letterSpacing: "0.1em", textTransform: "uppercase", padding: "6px 14px", fontWeight: 700 }}>
                    {p.badge}
                  </div>
                )}
                ...
                <a href="#contact" style={{
                  ...
                  background: p.featured ? "#0c0b0a" : "#b79d3e", color: p.featured ? "#b79d3e" : "#0c0b0a",
