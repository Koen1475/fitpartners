...
export default function RoosterCBContent() {
  useEffect(() => {
    const tryInit = () => {
    ...
    <main>
      ...
      <section style={{ background: "#0c0b0a", padding: "56px 24px 80px" }}>
        <div style={{ maxWidth: 1200, margin: "0 auto" }}>
          ...
          <Script src="https://fitpartners.sportbitapp.nl/cbm/embed/rooster/cdn/" strategy="afterInteractive" />
        </div>
      </section>
      ...
      <section style={{ background: "#131211", padding: "64px 24px", textAlign: "center" }}>
        <div style={{ maxWidth: 480, margin: "0 auto" }}>
          ...
          <a href="tel:06-14634488" style={{ display: "inline-block", background: "#b79d3e", color: "#0c0b0a", padding: "14px 36px", fontWeight: 700, fontSize: 13, letterSpacing: "0.08em", textTransform: "uppercase", textDecoration: "none" }}>
            Bel 06-14634488
          </a>
        </div>
      </section>
      ...
      <style>{`
        ...
        #sportbit-rooster .embed-rooster .top { background: #131211 !important; border-bottom: 1px solid #2a2720 !important; padding: 14px 20px !important; }
        #sportbit-rooster .embed-rooster .top .today a, #sportbit-rooster .embed-rooster .top .week a { background: #b79d3e !important; color: #0c0b0a !important; border: none !important; border-radius: 0 !important; font-weight: 700 !important; font-size: 11px !important; letter-spacing: 0.06em !important; text-transform: uppercase !important; padding: 7px 14px !important; }
        ...
        #sportbit-rooster .embed-rooster .days { background: #131211 !important; border-bottom: 2px solid #b79d3e !important; }
        ...
        #sportbit-rooster .embed-rooster .calendar .sepparator { background: #0c0b0a !important; color: #b79d3e !important; font-size: 10px !important; font-weight: 700 !important; letter-spacing: 0.12em !important; text-transform: uppercase !important; border-right: 1px solid #2a2720 !important; border-top: 1px solid #2a2720 !important; }
        #sportbit-rooster .embed-rooster .calendar .items-day div.evtitem { background: #131211 !important; border: none !important; border-left: 4px solid #b79d3e !important; border-radius: 0 !important; margin: 3px 6px !important; padding: 7px 10px !important; cursor: pointer !important; transition: background 0.2s ease, transform 0.2s ease, box-shadow 0.2s ease, border-left-color 0.2s ease !important; }
        ...
        #sportbit-rooster .embed-rooster .calendar .items-day div.evtitem.gepasseerd { background: #131211 !important; border-left-color: #b79d3e !important; opacity: 1 !important; }
        ...
        #sportbit-rooster .embed-rooster .calendar .items-day div.evtitem .time { color: #b79d3e !important; font-size: 11px !important; font-weight: 600 !important; display: block !important; margin-top: 2px !important; }
        ...
        #sportbit-rooster .embed-rooster .lds-dual-ring:after { border-color: #b79d3e transparent #b79d3e transparent !important; }
        ...
        #sportbit-rooster .embed-rooster .popup .popup-close { color: #b79d3e !important; }
      `}</style>
    </main>
  );
}
