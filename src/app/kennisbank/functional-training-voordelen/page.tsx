      ...
      <section style={{ background: "#131211", padding: "100px 24px 64px", borderBottom: "1px solid #2a2720" }}>
        <div style={{ maxWidth: 760, margin: "0 auto" }}>
          ...
          <div style={{ display: "flex", gap: 16, alignItems: "center", marginBottom: 24 }}>
            <span style={{ color: "#b79d3e", fontSize: 11, letterSpacing: "0.14em", textTransform: "uppercase", fontWeight: 700 }}>Training</span>
        ...
        <div style={{ maxWidth: 760, margin: "0 auto" }}>
          ...
          {voordelen.map((v, i) => (
            <Reveal key={i}>
              <div style={{ display: "flex", gap: 28, marginBottom: 48, paddingBottom: 48, borderBottom: "1px solid #2a2720" }}>
                <span style={{ fontFamily: "var(--font-anton)", fontSize: 40, color: "#b79d3e", opacity: 0.35, lineHeight: 1, flexShrink: 0, width: 52 }}>{v.nr}</span>
                <div>
          ...
          <Reveal>
            <div style={{ background: "#131211", border: "1px solid #b79d3e", padding: "36px 40px", textAlign: "center" }}>
              <p style={{ color: "#b79d3e", fontSize: 11, letterSpacing: "0.14em", textTransform: "uppercase", fontWeight: 700, margin: "0 0 12px" }}>Klaar om te starten?</p>
