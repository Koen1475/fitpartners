  ...
  return (
    <div style={{ borderBottom: "1px solid #2a2720" }}>
      ...
      >
        ...
        <ChevronDown size={18} color="#BC9C22" style={{ flexShrink: 0, transition: "transform 0.25s", transform: open ? "rotate(180deg)" : "rotate(0)" }} />
      </button>
      {open && (
    ...
    <main>
      <section style={{ background: "#131211", padding: "100px 24px 64px", borderBottom: "1px solid #2a2720" }}>
        <div style={{ maxWidth: 760, margin: "0 auto" }}>
          <Link href="/kennisbank" style={{ color: "#BC9C22", fontSize: 12, letterSpacing: "0.15em", textTransform: "uppercase", textDecoration: "none", display: "inline-block", marginBottom: 20 }}>
            ← Kennisbank
          </Link>
          ...
          <p style={{ color: "#b8b3aa", fontSize: 16, lineHeight: 1.8, margin: 0 }}>
            ...
            <a href="tel:06-14634488" style={{ color: "#BC9C22", textDecoration: "none" }}>06-14634488</a>.
          </p>
        </div>
      </section>
      ...
      <section style={{ background: "#0c0b0a", padding: "72px 24px 96px" }}>
        <div style={{ maxWidth: 760, margin: "0 auto", display: "flex", flexDirection: "column", gap: 56 }}>
          {faqs.map(cat => (
            <div key={cat.cat}>
              <h2 style={{ fontFamily: "var(--font-anton)", fontSize: 20, textTransform: "uppercase", color: "#BC9C22", margin: "0 0 8px", letterSpacing: "0.08em" }}>{cat.cat}</h2>
        ...
        <div style={{ maxWidth: 760, margin: "64px auto 0", background: "#131211", border: "1px solid #2a2720", padding: "40px", textAlign: "center" }}>
          <p style={{ color: "#BC9C22", fontSize: 11, letterSpacing: "0.14em", textTransform: "uppercase", fontWeight: 700, margin: "0 0 12px" }}>Nog vragen?</p>
