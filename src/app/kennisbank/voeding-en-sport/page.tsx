    ...
    <main>
      ...
      <section style={{ background: "#131211", padding: "100px 24px 64px", borderBottom: "1px solid #2a2720" }}>
        <div style={{ maxWidth: 760, margin: "0 auto" }}>
          <Link href="/kennisbank" style={{ color: "#b79d3e", fontSize: 12, letterSpacing: "0.15em", textTransform: "uppercase", textDecoration: "none", display: "inline-block", marginBottom: 24 }}>
            ← Kennisbank
          </Link>
          <div style={{ display: "flex", gap: 16, alignItems: "center", marginBottom: 24 }}>
            <span style={{ color: "#b79d3e", fontSize: 11, letterSpacing: "0.14em", textTransform: "uppercase", fontWeight: 700 }}>Voeding</span>
      ...
      <article style={{ background: "#0c0b0a", padding: "72px 24px 96px" }}>
        <div style={{ maxWidth: 760, margin: "0 auto" }}>
              ...
              {[
                ...
                <div key={m.name} style={{ background: "#131211", border: "1px solid #2a2720", padding: "24px 28px", display: "grid", gridTemplateColumns: "160px 1fr", gap: 24, alignItems: "start" }}>
                  <div>
                    ...
                    <span style={{ color: "#b79d3e", fontSize: 11, letterSpacing: "0.1em", textTransform: "uppercase", fontWeight: 700 }}>{m.role}</span>
                  </div>
                  ...
                  <ul style={{ listStyle: "none", margin: 0, padding: 0 }}>
                    {phase.tips.map((tip, j) => (
                      <li key={j} style={{ display: "flex", gap: 12, color: "#b8b3aa", fontSize: 14, lineHeight: 1.7, marginBottom: 6 }}>
                        <span style={{ color: "#b79d3e", flexShrink: 0 }}>–</span>
                        {tip}
                      </li>
                    ))}
                  </ul>
          ...
          <Reveal>
            <div style={{ background: "#131211", border: "1px solid #2a2720", borderLeft: "4px solid #b79d3e", padding: "28px 32px", margin: "0 0 56px" }}>
            ...
            <ul style={{ listStyle: "none", margin: "0 0 64px", padding: 0 }}>
              {[
                ...
                <li key={i} style={{ display: "flex", gap: 16, padding: "13px 0", borderBottom: "1px solid #2a2720", color: "#cfc9bd", fontSize: 15, lineHeight: 1.5 }}>
                  <span style={{ color: "#b79d3e", fontWeight: 700, flexShrink: 0 }}>✗</span>
                  {fout}
                </li>
              ))}
            </ul>
          ...
          <Reveal>
            <div style={{ background: "#131211", border: "1px solid #b79d3e", padding: "36px 40px", textAlign: "center" }}>
              <p style={{ color: "#b79d3e", fontSize: 11, letterSpacing: "0.14em", textTransform: "uppercase", fontWeight: 700, margin: "0 0 12px" }}>Persoonlijk voedingsadvies</p>
              ...
              <Link href="/wat-bieden-wij/voedingsadvies" style={{ display: "inline-block", background: "#b79d3e", color: "#0c0b0a", padding: "14px 32px", fontWeight: 700, fontSize: 13, letterSpacing: "0.08em", textTransform: "uppercase", textDecoration: "none" }}>
