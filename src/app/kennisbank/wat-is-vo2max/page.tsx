    ...
    <main>
      ...
      <section style={{ background: "#131211", padding: "100px 24px 64px", borderBottom: "1px solid #2a2720" }}>
        <div style={{ maxWidth: 760, margin: "0 auto" }}>
          <Link href="/kennisbank" style={{ color: "#b79d3e", fontSize: 12, letterSpacing: "0.15em", textTransform: "uppercase", textDecoration: "none", display: "inline-flex", alignItems: "center", gap: 8, marginBottom: 24 }}>
            ← Kennisbank
          </Link>
          <div style={{ display: "flex", gap: 16, alignItems: "center", marginBottom: 24 }}>
            <span style={{ color: "#b79d3e", fontSize: 11, letterSpacing: "0.14em", textTransform: "uppercase", fontWeight: 700 }}>Sportonderzoek</span>
      ...
      <article style={{ background: "#0c0b0a", padding: "72px 24px 96px" }}>
        <div style={{ maxWidth: 760, margin: "0 auto" }}>
          ...
          <Reveal>
            <div style={{ background: "#131211", border: "1px solid #2a2720", borderLeft: "4px solid #b79d3e", padding: "28px 32px", margin: "0 0 64px" }}>
            ...
            <div style={{ display: "grid", gap: 16, margin: "0 0 40px" }}>
              {[
                ...
                <div key={i} style={{ background: "#131211", border: "1px solid #2a2720", padding: "24px 28px", display: "flex", gap: 20 }}>
                  <span style={{ color: "#b79d3e", fontFamily: "var(--font-anton)", fontSize: 20, flexShrink: 0, lineHeight: 1 }}>0{i + 1}</span>
                  <div>
          ...
          <Reveal>
            <div style={{ background: "#131211", border: "1px solid #b79d3e", padding: "36px 40px", textAlign: "center" }}>
              <p style={{ color: "#b79d3e", fontSize: 11, letterSpacing: "0.14em", textTransform: "uppercase", fontWeight: 700, margin: "0 0 12px" }}>Wil jij jouw VO2max meten?</p>
              ...
              <Link href="/wat-bieden-wij/sportonderzoeken" style={{ display: "inline-block", background: "#b79d3e", color: "#0c0b0a", padding: "14px 32px", fontWeight: 700, fontSize: 13, letterSpacing: "0.08em", textTransform: "uppercase", textDecoration: "none" }}>
