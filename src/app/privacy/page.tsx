        ...
        <div style={{ maxWidth: 760, margin: "0 auto", display: "flex", flexDirection: "column", gap: 48 }}>
          {sections.map((s, i) => (
            <div key={i} style={{ display: "grid", gridTemplateColumns: "32px 1fr", gap: "0 24px", alignItems: "start" }}>
              <span style={{ fontFamily: "var(--font-anton)", fontSize: 13, color: "#b79d3e", opacity: 0.5, paddingTop: 3 }}>
          ...
          <div style={{ borderTop: "1px solid #2a2720", paddingTop: 32, marginTop: 8 }}>
            <p style={{ color: "#6f6a60", fontSize: 13, lineHeight: 1.7, margin: 0 }}>
              ...
              <a href="mailto:info@fit-partners.nl" style={{ color: "#b79d3e", textDecoration: "none" }}>info@fit-partners.nl</a>
            </p>
          </div>
        </div>
      </section>
