  ...
  return (
    <main style={{ background: "#0c0b0a", minHeight: "70vh", display: "flex", alignItems: "center", justifyContent: "center", padding: "80px 24px" }}>
      <div style={{ textAlign: "center", maxWidth: 520 }}>
        ...
        <div style={{ width: 48, height: 2, background: "#BC9C22", margin: "0 auto 32px" }} />
        ...
        <div style={{ display: "flex", gap: 12, justifyContent: "center", flexWrap: "wrap" }}>
          <Link href="/" style={{ background: "#BC9C22", color: "#0c0b0a", padding: "14px 32px", fontWeight: 700, fontSize: 13, letterSpacing: "0.08em", textTransform: "uppercase", textDecoration: "none" }}>
            Terug naar home
          </Link>
