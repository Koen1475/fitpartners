          ...
          {partners.map((p, i) => (
            <Reveal key={p.name} delay={(i + 1) as 1 | 2}>
              <div style={{
                ...
                {/* Content */}
                <div>
                  <p style={{ color: "#BC9C22", fontSize: 11, letterSpacing: "0.14em", textTransform: "uppercase", fontWeight: 700, margin: "0 0 10px" }}>{p.tag}</p>
                ...
                <div style={{ width: 36, height: 2, background: "#BC9C22", marginTop: "auto" }} />
              </div>
            </Reveal>
          ))}
        </div>
