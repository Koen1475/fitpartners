  ...
  return (
    <div style={{ display: "grid", gridTemplateColumns: "1.2fr 0.8fr 1fr", gridTemplateRows: "240px 180px", gap: 6 }} className="staggered-gallery">
      ...
      <div style={{ position: "relative", overflow: "hidden", marginTop: 32 }}>
        ...
        <div style={{ position: "absolute", inset: 0, borderLeft: "3px solid #BC9C22", opacity: 0.4 }} />
      </div>
    ...
    <ul style={{ listStyle: "none", margin: 0, padding: 0 }}>
      {items.map((item, i) => (
        <li key={i} style={{ display: "flex", alignItems: "flex-start", gap: 16, padding: "12px 0", borderBottom: "1px solid #2a2720" }}>
          <span style={{ color: "#BC9C22", fontSize: 16, flexShrink: 0, marginTop: 1, fontWeight: 700 }}>✓</span>
  ...
  return (
    <main>
      ...
      <section style={{ background: "#131211", padding: "72px 24px" }}>
        <div style={{ maxWidth: 900, margin: "0 auto" }}>
          <Reveal>
            ...
            <div style={{ width: 40, height: 2, background: "#BC9C22", margin: "16px 0 40px" }} />
          </Reveal>
          <Reveal>
      ...
      <section style={{ background: "#0c0b0a", padding: "72px 24px" }}>
        <div style={{ maxWidth: 900, margin: "0 auto" }}>
          <Reveal>
            <p style={{ fontSize: 16, color: "#b8b3aa", lineHeight: 1.9, margin: "0 0 64px", borderLeft: "3px solid #BC9C22", paddingLeft: 28 }}>
