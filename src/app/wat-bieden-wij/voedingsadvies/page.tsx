    ...
    <main>
      ...
      <section style={{ position: "relative", height: 400, display: "flex", alignItems: "flex-end", overflow: "hidden" }}>
        ...
        <div style={{ position: "relative", maxWidth: 1200, margin: "0 auto", padding: "0 24px 64px", width: "100%" }}>
          ...
          <p style={{ color: "#b79d3e", fontSize: 20, fontStyle: "italic", margin: 0 }}>
      ...
      <section style={{ background: "#131211", padding: "72px 24px" }}>
        <div style={{ maxWidth: 860, margin: "0 auto" }}>
          <Reveal>
            <div style={{ borderLeft: "3px solid #b79d3e", paddingLeft: 28, marginBottom: 48 }}>
              <p style={{ fontSize: 13, color: "#b79d3e", letterSpacing: "0.12em", textTransform: "uppercase", margin: "0 0 12px", fontWeight: 700 }}>Ons motto</p>
      ...
      <section style={{ background: "#0c0b0a", padding: "72px 24px" }}>
        <div style={{ maxWidth: 1000, margin: "0 auto" }}>
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(300px, 1fr))", gap: 2 }}>
            ...
            <Reveal delay={1}>
              <div style={{ background: "#131211", padding: "44px 40px", borderTop: "2px solid #b79d3e", height: "100%" }}>
                <div style={{ fontFamily: "var(--font-anton)", fontSize: 48, color: "#b79d3e", opacity: 0.2, lineHeight: 1, marginBottom: 20 }}>01</div>
            ...
            <Reveal delay={2}>
              <div style={{ background: "#131211", padding: "44px 40px", borderTop: "2px solid #b79d3e", height: "100%" }}>
                <div style={{ fontFamily: "var(--font-anton)", fontSize: 48, color: "#b79d3e", opacity: 0.2, lineHeight: 1, marginBottom: 20 }}>02</div>
                <h2 style={{ fontFamily: "var(--font-anton)", fontSize: 22, textTransform: "uppercase", color: "#f4efe6", margin: "0 0 20px" }}>
                  Alles onder één dak
                </h2>
                <p style={{ color: "#a39d92", fontSize: 15, lineHeight: 1.9, margin: 0 }}>
