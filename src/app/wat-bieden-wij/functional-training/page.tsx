    ...
    <main>
      ...
      <section style={{ background: "#0c0b0a", padding: "72px 24px" }}>
        <div style={{ maxWidth: 860, margin: "0 auto" }}>
          <Reveal>
            <p style={{ fontSize: 22, color: "#cfc9bd", lineHeight: 1.7, fontWeight: 300, margin: "0 0 40px", borderLeft: "3px solid #BC9C22", paddingLeft: 28 }}>
                ...
                <Reveal key={i} delay={((i % 3) + 1) as 1 | 2 | 3}>
                  <div className="feature-card" style={{
                    ...
                    <div style={{
                      ...
                      <Icon size={20} color="#BC9C22" strokeWidth={1.5} />
                    </div>
                    <h3 style={{
      ...
      <style>{`
        ...
        .feature-card:hover { border-color: #BC9C22 !important; }
      `}</style>
    </main>
  );
}
