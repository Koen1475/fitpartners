  ...
  return (
    ...
    >
      ...
      <div style={{
        ...
        background: "linear-gradient(to top, rgba(12,11,10,0.85) 0%, rgba(12,11,10,0.1) 50%, transparent 100%)",
      ...
      <div style={{
        position: "absolute", inset: 0,
        background: "linear-gradient(to top, rgba(12,11,10,0.97) 0%, rgba(12,11,10,0.75) 50%, rgba(12,11,10,0.1) 100%)",
        transition: "opacity 0.4s ease",
        opacity: hovered ? 1 : 0,
      }} />
      ...
      <div style={{
        ...
        transform: hovered ? "translateY(-120px)" : "translateY(0)",
      }}>
        <h3 style={{ fontFamily: "var(--font-anton)", fontSize: featured ? 28 : 22, textTransform: "uppercase", color: "#f4efe6", margin: "0 0 4px", lineHeight: 1 }}>
          {t.name}
        </h3>
        <p style={{ color: "#b79d3e", fontSize: 12, margin: 0, letterSpacing: "0.06em", textTransform: "uppercase", fontWeight: 600 }}>
          {t.role}
        </p>
      </div>
      ...
      <div style={{
        position: "absolute", bottom: 0, left: 0, right: 0, padding: "20px 24px 24px",
        opacity: hovered ? 1 : 0,
        transform: hovered ? "translateY(0)" : "translateY(16px)",
        transition: "opacity 0.35s ease 0.05s, transform 0.35s ease 0.05s",
      }}>
        <p style={{ color: "#b79d3e", fontSize: 10, letterSpacing: "0.14em", textTransform: "uppercase", margin: "0 0 10px", fontWeight: 700 }}>
          Specialisaties
        </p>
        {t.specs.map((s) => (
    ...
    <main>
      ...
      <section style={{ position: "relative", height: 360, display: "flex", alignItems: "flex-end", overflow: "hidden" }}>
        ...
        <div style={{ position: "relative", maxWidth: 1200, margin: "0 auto", padding: "0 24px 64px", width: "100%" }}>
          ...
          <p style={{ color: "#cfc9bd", fontSize: 17, lineHeight: 1.7, maxWidth: 600, margin: 0 }}>
            ...
            <span style={{ color: "#b79d3e", fontWeight: 700 }}>passie</span>.
            Omdat we ons werk met zoveel passie en enthousiasme doen, gaan we net even verder waar anderen stoppen.
          </p>
        </div>
      </section>
      ...
      <section style={{ background: "#0c0b0a", padding: "72px 24px 96px" }}>
        <div style={{ maxWidth: 1200, margin: "0 auto" }}>
          ...
          {/* Featured row: Niek wide + Maartje */}
          <Reveal>
          ...
          {/* Bottom row: Georgio, Robin, Lindy */}
          <Reveal delay={1}>
